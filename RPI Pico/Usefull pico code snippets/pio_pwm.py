# -*- coding: utf-8 -*-
"""
Created on Thu Aug 26 21:51:44 2021.
...
class PIOPWM:
    """Class to controll the PIO pin to output a PWM signal."""

    def __init__(self, sm_id, pin, max_count, count_freq):
        """Inititalize the state machine."""
    ...
    def set(self, value):
        """Set the duty cycle."""
        # Minimum value is -1 (completely turn off), 0 actually
        # still produces narrow pulse
        value = max(value, -1)
