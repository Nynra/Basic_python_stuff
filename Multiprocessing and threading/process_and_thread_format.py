...
from pipe_communication import close_pipe, write_pipe, read_pipe, SENTINEL
...
class Thread_format():
    ...
    def start(self, shutdown_event, f, *args, **kwargs):
        """Start the process."""
        self.shutdown_event = shutdown_event
        self.thread = Thread(target=self.update, args=(shutdown_event, f,
                                                       args, kwargs,))
        self.thread.start()
    ...
    def update(self, shutdown_event, f, *args, **kwargs):
